							...
							<div class="box box-info">
								...
								<div class="box-body">
									<div class="col-sm-6">
										<div align="center">
											<img alt="User Pic"
												src="resources/imgFile/${login.stu_path}"
									...
									<div class="col-sm-7 col-xs-6 ">${login.stu_name}</div>
									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">성별</div>
									<div class="col-sm-7 col-xs-6 ">${login.stu_gen}</div>
									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">학년</div>
									<div class="col-sm-7">${login.stu_year}</div>
									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">생년월일</div>
									<div class="col-sm-7">${login.stu_birth}</div>
									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">상태</div>
									<div class="col-sm-7">${login.state}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">국적</div>
									<div class="col-sm-7">${login.stu_coun}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">학과</div>
									<div class="col-sm-7">${login.dept_nm}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">연락처</div>
									<div class="col-sm-7">${login.stu_tel}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">E-mail</div>
									<div class="col-sm-7">${login.stu_email}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">우편번호</div>
									<div class="col-sm-7">${login.stu_zip}</div>

									<div class="clearfix"></div>
									<div class="bot-border"></div>

									<div class="col-sm-5 col-xs-6 tital ">주소</div>
									<div class="col-sm-7">${login.stu_address}</div>
