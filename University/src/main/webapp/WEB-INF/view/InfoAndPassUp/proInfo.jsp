                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <div class="col-sm-6">
                                    <div align="center">
                                        <img alt="User Pic"
                                             src="resources/imgFilePro/${login.prof_path}"
                                ...
                                <div class="col-sm-7 col-xs-6 ">${login.prof_nm}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">교수번호</div>
                                <div class="col-sm-7 col-xs-6 ">${login.prof_cd}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">성별</div>
                                <div class="col-sm-7 col-xs-6 ">${login.prof_gen}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">생년월일</div>
                                <div class="col-sm-7">${login.prof_birth}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">국적</div>
                                <div class="col-sm-7">${login.prof_coun}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>
                                ...
                                <div class="col-sm-7">${login.prof_tel}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">E-mail</div>
                                <div class="col-sm-7">${login.prof_email}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">우편번호</div>
                                <div class="col-sm-7">${login.prof_zip}</div>
                                <div class="clearfix"></div>
                                <div class="bot-border"></div>

                                <div class="col-sm-5 col-xs-6 tital ">주소</div>
                                <div class="col-sm-7">${login.prof_address}</div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                        </div>
