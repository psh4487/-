...
<body>
	...
	<h4 style="margin-top:15px"> 봉사활동 추가 </h4>
		...
		<form name = form1 method = "post" action = '<c:url value = 'insertService.do'/>' enctype = "multipart/form-data" target = "service">
			...
			봉사시간 <input type = "text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="margin-top: 10px" name = "ser_time" id = "ser_time"><br>
			...
			<input type = "submit" class="btn btn-dark"  value = "업로드" onClick = "return writeSave()">
