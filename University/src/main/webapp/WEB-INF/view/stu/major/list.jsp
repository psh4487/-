...
function selectList(){
	...
	$.ajax({
		...
		.done(
				function(args){
					$("#console").html("");
					var main = "<table class='table table-striped custab' id='cultureInfo' style='text-align:center'><tr><td>강의코드</td><td>강의명</td><td>이수구분</td><td>학점</td><td>학과</td>"+
						"<td>교수</td><td>강의시간</td><td>인원제한</td><td>수강인원</td><td>강의 계획서</td></tr></table>";
					$("#console").append(main);					
