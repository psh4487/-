...
<div style="text-align:center; width:1150px;">
   ...
   <table border="1" style="text-align:center; width:1150px; font-size:10pt; margin-left:200px;">
      <tr>
      ...
      <c:forEach var="i" begin="0" end="8">
         <tr>
            <td style = "background-color:orange;" height="60px">${i+1}교시<br>(${i+8}:00~${i+9}:50)</td>
